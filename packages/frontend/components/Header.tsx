    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 p-4">
        ...
        <ul
          ...
          } flex lg:items-center lg:gap-4 lg:relative absolute lg:top-0 top-[83px] left-0 lg:flex-row flex-col w-full lg:w-fit lg:p-0 p-2 gap-4 lg:drop-shadow-none lg:opacity-100 lg:visible drop-shadow-xl transition-all duration-300`}
        >
          <li
